...
public class EmulationPerformance {
    ...
    public static void updateExcel(long number, String excelFilePath, int numberRow, int numberColumn,int numberSheet){
    ...
    public static void getLatenciesOc(OrganizationChartService ocService,String excelFilePath,int numberRow, int numberColumn,int numberSheet) throws InterruptedException, SQLException {
        //organizationchart
        long start, end;
    ...
    public static void getLatenciesDo(DidacticOfferService doService,String excelFilePath,int numberRow, int numberColumn,int numberSheet) throws InterruptedException, SQLException {
        //didacticoffer
        long start, end;
    ...
    public static void getLatenciesTa(ThesisApprovationService taService,String excelFilePath,int numberRow, int numberColumn,int numberSheet) throws InterruptedException, SQLException {
        //thesis approvation
        long start, end;
