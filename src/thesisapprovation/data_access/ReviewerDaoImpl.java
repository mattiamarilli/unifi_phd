...
public class ReviewerDaoImpl implements ReviewerDao{
    ...
    @Override
    public Reviewer getReviewerByFreshman(int f) throws SQLException {
    ...
    @Override
    public void insertReviewer(Reviewer reviewer) throws SQLException {
    ...
    @Override
    public void deleteReviewer(int freshman) throws SQLException {
